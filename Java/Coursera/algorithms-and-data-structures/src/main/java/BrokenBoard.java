...
public class BrokenBoard {
    ...
    public BrokenBoard twin() {// a board that is obtained by exchanging any pair of blocks
        ...
        BrokenBoard twin = new BrokenBoard(twinColumnsArray);
    ...
    private void addNeighbors(Stack<BrokenBoard> neighbors) {
        ...
        if (rowUp >= 0 && rowUp < N) {
            ...
            neighbors.add(new BrokenBoard(neighborBoard));
        }
